...
class VHListSelected(private val context: Context, private val itemBinding: ItemStyleCompactBinding, private val listener: OnItemClickListener): RecyclerView.ViewHolder(itemBinding.root) {
        ...
        itemBinding.apply {
            ...
            itemTvName.setOnClickListener {
                ...
                popupMenu.menu.add("Delete").setOnMenuItemClickListener {
                    listener.setOnItemClickListener(user, EnumItem.UNSELECT, null)
                    listener.setOnItemClickListener(user, EnumItem.DELETE, null)
                    true
                }
                popupMenu.show()
