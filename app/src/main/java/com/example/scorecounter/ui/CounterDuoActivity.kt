...
import com.example.scorecounter.databinding.ActivityCounterDuoBinding
...
class CounterDuoActivity : AppCompatActivity() {
    ...
    private fun populateViewParticipantA(user: User) {
        binding.duoScore1.text = user.score.toString()
        binding.duoCard1.setCardBackgroundColor(user.color)
    }

    private fun populateViewParticipantB(user: User) {
        binding.duoScore2.text = user.score.toString()
        binding.duoCard2.setCardBackgroundColor(user.color)
    }

    private fun initSpinnerSelectParticipantA() {
        viewModel.users.observe(this) {

            spinnerA = binding.duoSpinner1
    ...
    private fun setOnClickEditIcon() {
        ...
        binding.duoEdit1.setOnClickListener {
        ...
        binding.duoEdit2.setOnClickListener {
            val popupMenu = PopupMenu(this, it)
            popupMenu.menu.add("Edit").setOnMenuItemClickListener {
