...
class VHCompactList (private val context: Context, private val itemBinding: ItemCounterCompactListBinding, private val listener: OnItemClickListener): RecyclerView.ViewHolder(itemBinding.root) {
    ...
    fun adapterView(user: User, pos: Int) {
        ...
        // binding click
        // Add point
        itemBinding.ivAddPoint.setOnClickListener {
            listener.setOnItemClickListener(user, EnumItem.ADD_POINT, pos)
        }

        // Remove point
        itemBinding.ivRemovePoint.setOnClickListener {
